...
create_table(array("Nama Mapel", "Topik", "Tanggal", "Waktu", "Jml. Soal", "Penguji", "Aksi"));

//membuat form tambah dan edit data
open_form("modal_ujian", "return save_data()");
   create_textbox("Topik", "topik", "text", 4, "", "required");
   ...
   $quser = mysqli_query($mysqli, "SELECT * FROM guru");
   $list = array();
